...
def login():
    def connect():
        ...
        vvv = Label(text=f"Version: {version}ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ\n\n\n\n\n\n\n\n\n\n\n\n")
        vvv.pack()
...
if version == data['version']:
    ...
    update()# Fait par "Mathéo PICHOT-MOÏSE" alias "Kuco"
# https://github.com/KucoDEV
# (c) Copyright, KucoDEV 2022-2023
# Required PIP packages: requests, tkcalendar
...
def login():
    def connect():
        ...
        login_screen.geometry("300x250")
        login_screen.resizable(False, False)
        vvv = Label(text=f"\nVersion: {version}ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ\n\n\n\n\n\n\n\n\n\n\n")
        vvv.pack()
        Label(login_screen, text="Veuillez rensigner les informations de votre compte").pack()
        Label(login_screen, text="").pack()
